      ...
      >
        ...
        <li className="flex flex-col md:flex-row gap-2 md:gap-4 w-full md:w-auto mt-2 md:mt-0">
          <Link href="/shorten" onClick={() => setMenuOpen(false)}>
            <button className="bg-cyan-600 hover:bg-cyan-800 shadow-lg rounded-lg px-6 py-2 font-semibold border-2 border-cyan-800 w-full md:w-auto transition">Try Now</button>
          </Link>
          <Link href="/github" onClick={() => setMenuOpen(false)}>
            <button className="bg-cyan-600 hover:bg-cyan-800 shadow-lg rounded-lg px-6 py-2 font-semibold border-2 border-cyan-800 w-full md:w-auto transition">Github</button>
          </Link>
        </li>
      </ul>
    </nav>
